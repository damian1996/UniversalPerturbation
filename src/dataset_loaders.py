...
class ReplayBuffer:
    ...
    def __init__(self, envs, multi_game=False):
...
class TrajectoriesLoader():
    ...
    def __init__(self, envs, algo, multi_game, saved_trajectories = "./saved_trajectories"):
        self.rep_buffer = ReplayBuffer(envs, multi_game=multi_game)
...
class FullDatasetLoader():
    ...
    def __init__(self, envs, batch_size, algo, multi_game=False):
        self.rng = default_rng()
        self.multi_game = multi_game
